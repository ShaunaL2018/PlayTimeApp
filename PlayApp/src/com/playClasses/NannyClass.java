...
public class NannyClass implements WorkerInterface{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		NannyClass other = (NannyClass) obj;
	...
	public String toString() {
		return "NannyClass [workerType=" + workerType + ", workerShift=" + workerShift + ", workerFirstName="
